...
public class FluentWorldNode extends MixinWorld implements FluentWorld {
  ...
  @Override
  @NotNull
  public List<FluentPackage> getPackageList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FluentPackage.class);
  }

  @Override
  @NotNull
  public List<FluentWorld> getWorldList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FluentWorld.class);
  }
