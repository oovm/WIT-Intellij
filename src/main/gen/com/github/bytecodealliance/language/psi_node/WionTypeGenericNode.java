...
public class WionTypeGenericNode extends WionElement implements WionTypeGeneric {

  public WionTypeGenericNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WionGeneric getGeneric() {
    return findChildByClass(WionGeneric.class);
  }
