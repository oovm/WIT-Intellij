...
public class WionIncludeNameNode extends WionElement implements WionIncludeName {

  public WionIncludeNameNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WionIdentifier> getIdentifierList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WionIdentifier.class);
  }
  ...
  @Override
  @Nullable
  public WionPackageVersion getPackageVersion() {
    return findChildByClass(WionPackageVersion.class);
  }
