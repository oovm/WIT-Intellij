...
public class WitxGenericNode extends WitElement implements WitxGeneric {

  public WitxGenericNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WitxTypeHint> getTypeHintList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WitxTypeHint.class);
  }
