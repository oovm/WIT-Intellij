...
public class WionExportNode extends WionElement implements WionExport {

  public WionExportNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WionExportTerm getExportTerm() {
    return findChildByClass(WionExportTerm.class);
  }
