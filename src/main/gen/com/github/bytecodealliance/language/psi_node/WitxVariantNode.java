...
public class WitxVariantNode extends MixinVariant implements WitxVariant {

  public WitxVariantNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WitxVariantItem> getVariantItemList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WitxVariantItem.class);
  }
