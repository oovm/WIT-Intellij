...
public class WionPackageNode extends MixinPackage implements WionPackage {

  public WionPackageNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WionPackageName getPackageName() {
    return findChildByClass(WionPackageName.class);
  }
