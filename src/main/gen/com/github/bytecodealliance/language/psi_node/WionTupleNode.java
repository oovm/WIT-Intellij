...
public class WionTupleNode extends WionElement implements WionTuple {

  public WionTupleNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WionParameter> getParameterList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WionParameter.class);
  }
