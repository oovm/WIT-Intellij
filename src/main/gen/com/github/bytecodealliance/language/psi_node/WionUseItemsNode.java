...
public class WionUseItemsNode extends WionElement implements WionUseItems {

  public WionUseItemsNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WionUseAlias> getUseAliasList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WionUseAlias.class);
  }
