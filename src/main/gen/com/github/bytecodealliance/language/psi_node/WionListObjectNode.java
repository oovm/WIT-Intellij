...
public class WionListObjectNode extends WionElement implements WionListObject {

  public WionListObjectNode(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WionVisitor visitor) {
    visitor.visitListObject(this);
  }
