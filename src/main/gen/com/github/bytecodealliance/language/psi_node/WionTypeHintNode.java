...
public class WionTypeHintNode extends WionElement implements WionTypeHint {

  public WionTypeHintNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WionTypeGeneric getTypeGeneric() {
    return findChildByClass(WionTypeGeneric.class);
  }
