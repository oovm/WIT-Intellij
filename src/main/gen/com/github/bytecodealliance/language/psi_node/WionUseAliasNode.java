...
public class WionUseAliasNode extends WionElement implements WionUseAlias {

  public WionUseAliasNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WionAliasName getAliasName() {
    return findChildByClass(WionAliasName.class);
  }
