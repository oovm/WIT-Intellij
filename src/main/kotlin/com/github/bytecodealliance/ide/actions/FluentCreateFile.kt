...
import com.github.bytecodealliance.language.file.WitIcons.Companion.FILE
...
class FluentCreateFile :
    ...
    companion object {
        private val name = com.github.bytecodealliance.WitBundle.message("action.create_file")
        private val description = com.github.bytecodealliance.WitBundle.message("action.create_file.description")
