...
class FluentCreateFile :
    ...
    companion object {
        private val name = com.github.projectfluent.WitBundle.message("action.create_file")
        private val description = com.github.projectfluent.WitBundle.message("action.create_file.description")
